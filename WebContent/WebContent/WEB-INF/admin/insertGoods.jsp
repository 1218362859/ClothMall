...
<script type="text/javascript">
        ...
        window.onload = function () {
            var user = document.getElementById("sid");
            //给文本框的失去焦点事件注册监听
            user.onblur = function () {
                ...
                //2,打开连接
                xmlHttp.open("POST", "${pageContext.request.contextPath }/seller/findSellerById.action", true);
                //3,设置请求头
...
<SCRIPT type="text/javascript">
	...
	function insert() {
		if (confirm("确认添加？")) {
			...
			document.forms.form1.action = " ${pageContext.request.contextPath}/goods/insertGoodsCategory.action";
				...
				<div class="am-form-group am-cf">
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm" name="unit"
								 id="doc-ipt-pwd-1" placeholder="请输入规格">
							</div>
						</div>
						<div class="am-form-group am-cf">
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								...
								id="doc-ipt-pwd-1" placeholder="请输入用途">
							</div>
						</div>
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="number" class="am-input-sm" name="sales"  value="0"  min="0" 
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="number" class="am-input-sm" name="score"  value="0"  min="0" max="10" 
									id="doc-ipt-pwd-1" 
